...
const STEPS: { id: Exclude<HowtoScreen, 'home'>; n: number; short: string; hint: string }[] = [
  ...
  },
  {
    ...
    n: 2,
    short: 'Alert',
    hint: 'Open the station and set when to notify (wind, gust, temp, or waves). Alerts go to this phone; Menu → Alerts can add email.',
  },
  {
    id: 'install',
    n: 3,
    short: 'Install',
    hint: 'Menu → Install app for lock-screen alerts on this phone',
  },
  {
    id: 'account',
    n: 4,
    short: 'Account',
    hint: 'Menu → Account to sync this list to another phone',
  },
];
...
const SIMPLE_STEPS: typeof STEPS = [
  {
    ...
    n: 1,
    short: 'Add',
    hint: 'Tap Follow on Home and add a Windguru station',
  },
  {
    id: 'station',
    n: 2,
  ...
  },
  {
    ...
    n: 3,
    short: 'Install',
    hint: 'Menu → Put on home screen so pings can wake this phone',
  },
  {
    id: 'account',
    n: 4,
...
export function FirstTimeBanner({ screen, simple, onDismiss, onFollow }: Props) {
  const steps = stepsFor(simple);
